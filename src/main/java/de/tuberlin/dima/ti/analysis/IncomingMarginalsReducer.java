...
// sums up incoming capacity of an airport for TM estimation
public class IncomingMarginalsReducer implements GroupReduceFunction<Tuple7<String, String, Boolean, Boolean, Boolean, Integer, Integer>, Tuple8<String, String, Boolean, Boolean, Boolean, Integer, Double, Boolean>> {
