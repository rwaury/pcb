...
// Tuple23< String,         String,         String,         String,         String,         String,         Double,     Double,     Long,
//          originAirport,  originTerminal, originCity,     originState,    originCountry,  originRegion,   originLat,  originLong, departureTimestamp,
//          String,         String,         String,         String,         String,         String,         Double,     Double,     Long,
//          destAirport,    destTerminal,   destCity,       destState,      destCountry,    destRegion,     destLat,    destLong,   arrivalTimestamp,
//          String,     Integer,        String,         Integer,        String,         String>
//          airline,    flightNumber,   aircraftType,   maxCapacity,    codeshareInfo,  lastAirport
public class Flight extends Tuple15<GeoInfo, Long, GeoInfo, Long,
    ...
    public Flight(String originAirport, String originTerminal, String originCity, String originState, String originCountry, String originRegion, Double originLatitude, Double originLongitude, Long departureTimestamp,
        ...
        this.f12 = FlightConnectionJoiner.getFirstWindow(departureTimestamp); // dep window 1
